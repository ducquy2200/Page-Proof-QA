    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-2">
        <textarea
          ...
          style={{ backgroundColor: c.bgInput, border: `1px solid ${c.borderMid}`, color: c.textPrimary, caretColor: c.accent }}
          onFocus={e => e.target.style.borderColor = c.accent}
          onBlur={e => e.target.style.borderColor = c.borderMid}
        />
        <Button onClick={handleSubmit} disabled={!ready || loading || !question.trim()} className="self-end">
